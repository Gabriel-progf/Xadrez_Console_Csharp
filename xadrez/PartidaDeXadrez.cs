...
namespace xadrez
{
    class PartidadeXadrez
    {
        ...
        private void colocarPeca()
        {
            ...
            tab.colocarPeca(new Torre(tab, Cor.Preta), new PosicaXadrez('c', 8).toPosicao());
            tab.colocarPeca(new Torre(tab, Cor.Preta), new PosicaXadrez('c', 7).toPosicao());
            tab.colocarPeca(new Torre(tab, Cor.Preta), new PosicaXadrez('d', 7).toPosicao());
            tab.colocarPeca(new Torre(tab, Cor.Preta), new PosicaXadrez('e', 8).toPosicao());
            tab.colocarPeca(new Torre(tab, Cor.Preta), new PosicaXadrez('e', 7).toPosicao());
            tab.colocarPeca(new Rei(tab, Cor.Preta), new PosicaXadrez('d', 8).toPosicao());
